...
export const DICT = {
  id: {
    ...
    'machines.routingNote': 'Belum mengarahkan job: satu antrean masih dilayani PC mana pun yang mengambil lebih dulu. Sampai routing per-PC ada, daftar ini untuk mengganti dan mencabut token tanpa redeploy — jangan memasang PC kedua yang sungguhan dulu.',
  ...
  en: {
    ...
    'machines.routingNote': 'Jobs are not routed yet: one queue is still served by whichever PC claims first. Until per-PC routing exists, this list is for replacing and revoking tokens without a redeploy — do not add a real second PC yet.',
